...
local NexusApi = "Dragon X Hub - Blox Fruit"
local filename = "BloxFruits.json"
local foldername = "Dragon X Hub"
_G.Settings = {
...
ThunderImageUI.Image = "rbxassetid://17077120990"
local ThunderCornerUI = Instance.new("UICorner")
ThunderCornerUI.Name = "ThunderCornerUI"
...
Title.Text = "Dragon X Hub | ".."<font color='rgb(0, 0, 255)'>[Premium]</font> 🇻🇳"
Title.RichText = true;
...
Menu_Setting.Image = "http://www.roblox.com/asset/?id=17077120990"
...
Settings.Image = "http://www.roblox.com/asset/?id=17077120990"
...
Main_Page:Label("Welcome To Dragon X Hub")
Main_Page:Seperator("Discord")
Main_Page:Button('Copy Link Discord Hub',function()
setclipboard('https://discord.com/invite/yKUfwYQWbt')
end)
Main_Page:Button('Copy Link Discord Store',function()
setclipboard('https://discord.com/invite/yKUfwYQWbt')
end)
Main_Page:Seperator(" 🔰 Infomation ")
Main_Page:Label("Developer : HunterLoveQuynh")
Main_Page:Label("Script type : Paid ")
Main_Page:Label("Script language : Eng ")
Main_Page:Label("Script Version : 2.4.0 ")
...
spawn(function()
 while wait() do
  if game.Players.LocalPlayer.Data.Level.Value == 2550 then
    ...
    local Dropdown = Tabs.Item:AddDropdown("Dropdown", {
        Title = "Select Weapon",
